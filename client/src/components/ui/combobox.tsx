...
function ComboboxTrigger({ className, children, ...props }: ComboboxPrimitive.Trigger.Props) {
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn("[&_svg:not([class*='size-'])]:size-4", className as any)}
      {...props}
    >
      {children}
...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto", className as any)}>
...
function ComboboxGroup({ className, ...props }: ComboboxPrimitive.Group.Props) {
  return (
    <ComboboxPrimitive.Group data-slot="combobox-group" className={cn(className as any)} {...props} />
  );
}
...
function ComboboxLabel({ className, ...props }: ComboboxPrimitive.GroupLabel.Props) {
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn("px-2 py-2 text-xs text-muted-foreground", className as any)}
      {...props}
    />
  );
}
...
function ComboboxChipsInput({ className, ...props }: ComboboxPrimitive.Input.Props) {
  return (
    <ComboboxPrimitive.Input
      ...
      className={cn("min-w-16 flex-1 outline-none", className as any)}
      {...props}
    />
  );
}
